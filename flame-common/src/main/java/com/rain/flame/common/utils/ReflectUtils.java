...
import com.rain.flame.common.utils.ClassHelper;
...
public final class ReflectUtils {
    ...
    public static Method findMethod(Object target, String name, @Nullable Class<?>... paramTypes){
        if(Constants.SERVICE_BEAN_NAME.equals(target.getClass().getName())){
            Method m = ReflectionUtils.findMethod(target.getClass(),"getRef");
            Object ref = ReflectionUtils.invokeMethod(m, target);
            return ReflectionUtils.findMethod(ref.getClass(),name,paramTypes);
        }
        throw new RuntimeException(name + " not found");
    }
    public static Object invokeMethod(Method method, @Nullable Object target, @Nullable Object... args) {
        if(Constants.SERVICE_BEAN_NAME.equals(target.getClass().getName())){
            Object obj = ReflectionUtils.invokeMethod(ReflectionUtils.findMethod(target.getClass(),"getRef"), target);
            return ReflectionUtils.invokeMethod(method, obj, args);
        }
        throw new RuntimeException(target + " invoke exception");
    }
}